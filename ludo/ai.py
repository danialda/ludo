    ...
    def expectimax(board, dice_roll, depth, is_maximizing_player, is_chance_node,players):
        ...
        if is_chance_node:  # Chance node: Expectation over dice rolls
            ...
            for roll in possible_dice_rolls:
                ...
                for new_board in board.get_possible_boards(Player.green.value if is_maximizing_player else Player.blue.value, roll):
        ...
        if is_maximizing_player:  # Maximizing player's turn
            max_eval = float('-inf')
            best_move = None
            for new_board in board.get_possible_boards(Player.green.value, dice_roll):  
            ...
            min_eval = float('inf')
            best_move = None
            for new_board in board.get_possible_boards(Player.blue.value, dice_roll):
