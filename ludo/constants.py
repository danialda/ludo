...
ludoBackGround = pygame.image.load("assets/ludoBackGround.png")

TWO_PLAYER_BUTTON_DIM = (200, 150, 200, 50)
FOUR_PLAYER_BUTTON_DIM = (200, 200, 200, 50)
EXIT_DIM = (200, 250, 200, 50)
TWO_PLAYER_FONT_DIM = (210, 159, 200, 50)
FOUR_PLAYER_FONT_DIM = (210, 209, 200, 50)
EXIT_FONT_DIM = (210, 259, 200, 50)
